# SliceSamples
This is a script for FL Studio's Edison audio editor. It slices up an audio track into non-silent regions and removes the silent part. I find this useful for splitting tracks from CDDA format sample CDs into individual samples.
...
3. If you're happy with the result, you can save the regions as individual WAVs by using 'File > Export Regions > For sampler use'.
